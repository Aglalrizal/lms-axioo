<nav class="navbar navbar-expand-lg sticky-top">
    <div class="container px-0">
        <a class="navbar-brand" href="./"><img src="./assets/images/brand/logo/logo.svg" alt="Geeks" /></a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarPages">
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="./pages/course-single.html">Course Single
                                        v1</a>
                                </li>
                                <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarAccount">
                        ...
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li class="text-wrap">
                                    <h5 class="dropdown-header text-dark">
                                        Instructor
                                    </h5>
                                    <p class="dropdown-text mb-0">
                                        Instructor dashboard for manage
                                        courses and earning.
                                    </p>
                                </li>
                                <li>
                        ...
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li class="text-wrap">
                                    ...
                                    <p class="dropdown-text mb-0">
                                        Students dashboard to manage
                                        your courses and subscriptions.
                                    </p>
                                </li>
                                <li>
                                    <hr class="mx-3" />
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="./pages/quiz-result.html">Quiz
                                                Result</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="./pages/my-learning.html">My
                                                Learning</a>
                                        </li>
                                        <li>
                        ...
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                <li class="text-wrap">
                                    ...
                                    <p class="dropdown-text mb-0">
                                        Master admin dashboard to manage
                                        courses, user, site setting ,
