                ...
                <li class="dropdown d-inline-block stopevent position-static">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg position-absolute mx-3 my-5"
                        ...
                        <div>
                            ...
                            <ul class="list-group list-group-flush simplebar-scrollable-y" style="height: 300px"
                                data-simplebar="init">
                                <div class="simplebar-wrapper" style="margin: 0px;">
                                                                ...
                                                                <a class="text-body" href="#">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="ms-3">
                                                                            ...
                                                                            <p class="mb-3 text-body">Krisitn Watsan
                                                                                like your comment on course Javascript
                                                                                Introduction!</p>
                                                                            <span class="fs-6">
                                                                                <span>
                                                                                    <span
                                                                ...
                                                                <a class="text-body" href="#">
                                                                    <div class="d-flex">
                                                                        <img src="../assets/images/avatar/avatar-2.jpg"
                                                                            ...
                                                                            class="avatar-md rounded-circle">
                                                                        <div class="ms-3">
                                                                            <h5 class="fw-bold mb-1">Brooklyn Simmons
                                                                            </h5>
                                                                            <p class="mb-3 text-body">Just launched a
                                                                                new Courses React for Beginner.</p>
                                                                            <span class="fs-6">
                                                                                <span>
                                                                                    <span
                                                                                        class="fe fe-thumbs-up text-success me-1"></span>
                                                                ...
                                                                <a class="text-body" href="#">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="ms-3">
                                                                            ...
                                                                            <p class="mb-3 text-body">You earn new
                                                                                certificate for complete the Javascript
                                                                                Beginner course.</p>
                                                                            <span class="fs-6">
                                                                                <span>
                                                                                    <span
                                    ...
                                    <div class="simplebar-placeholder" style="width: 328px; height: 595px;"></div>
                                </div>
                                ...
                                <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                                    <div class="simplebar-scrollbar"
                                        style="height: 151px; transform: translate3d(0px, 0px, 0px); display: block;">
                                    </div>
                                </div>
                            </ul>
                    ...
                    <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarPages">
                        <li class="dropdown-submenu dropend">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="../pages/course-category-v2.html">Course Category
                                        v2</a>
                                </li>
                                <li class="border-bottom my-2"></li>
                                ...
                                <li>
                                    <a class="dropdown-item" href="../pages/course-single-v3.html">Course Single
                                        v3</a>
                                </li>
                                <li class="border-bottom my-2"></li>
                                <li>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="../pages/certificate-blank.html">Certificate</a>
                                        </li>
                                        <li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="../pages/learning-path-single.html">Learning Path Single</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu dropend">
                            ...
                            <a class="list-group-item list-group-item-action border-0" href="../docs/changelog.html">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h5 class="mb-0">
                                            Changelog
                                            <span class="text-primary ms-1" id="changelog">v3.3.3</span>
                                        </h5>
