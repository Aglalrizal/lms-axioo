            ...
            <li class="nav-item">
                ...
                <div id="navCourses" class="collapse " data-bs-parent="#sideNavbar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="../../pages/dashboard/admin-course-category-single.html">Category
                                Single</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="navecommerce" class="collapse " data-bs-parent="#sideNavbar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="../../pages/dashboard/ecommerce/shopping-cart.html">Shopping
                                Cart</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="../../pages/dashboard/ecommerce/customer-single.html">Customer
                                Single</a>
                        </li>
                        <li class="nav-item">
