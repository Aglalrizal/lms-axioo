                            ...
                            <span class="icon-shape icon-xxl">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M63.3526 18.1589H0.482178V17.3519H63.3526V18.1589Z" fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M0.482178 18.1589V17.3519H63.3526V18.1589H0.482178Z" fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="icon-shape icon-xxl">
                                <svg width="64" height="54" viewBox="0 0 64 54" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M38.3813 37.8586H35.4226V40.6263H36.9391L38.3813 37.8586ZM34.4226 36.8586V41.6263H37.5456L40.03 36.8586H34.4226Z"
                                        fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <span class="icon-shape icon-xxl">
                                <svg width="64" height="62" viewBox="0 0 64 62" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M10.2397 56.6521V57.6761H0.716309L0.716309 56.6521H10.2397Z" fill="">
                                    </path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M15.0567 21.1095H25.5782V11.5183L24.5782 12.4299V20.1095H16.1537L15.0567 21.1095Z"
                                        fill=""></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="position-relative">
                ...
                <div class="tns-outer" id="tns1-ow">
                    <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span
                            class="current">13 to 16</span> of 10</div>
                    <div id="tns1-mw" class="tns-ovh">
                        <div class="tns-inner" id="tns1-iw">
                            <div class="sliderFirst  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                    ...
                                    <div class="card border">
                                        ...
                                        <div class="card-body d-flex flex-column gap-4">
                                            <div class="d-flex flex-column gap-2">
                                                ...
                                                <h3 class="mb-0 h4">
                                                    <a href="#!" class="text-inherit">Create Modern Website
                                                        Using HTML,CSS And Bootstrap</a>
                                                </h3>
                                ...
                                <div class="item tns-item tns-slide-active" id="tns1-item7">
                                    <div class="card border">
                                        <a href="#!">
                                            <img src="../assets/images/course/bootstrap.jpg" alt="figma"
                                                class="card-img-top img-fluid w-100">
                                ...
                                <div class="item tns-item tns-slide-active" id="tns1-item8">
                                    <div class="card border">
                                        <a href="#!">
                                            <img src="../assets/images/course/nuxt.jpg" alt="figma"
                                                class="card-img-top img-fluid w-100">
                                ...
                                <div class="item tns-item tns-slide-active" id="tns1-item9">
                                    <div class="card border">
                                        <a href="#!">
                                            <img src="../assets/images/course/bootstrap.jpg" alt="figma"
                                                class="card-img-top img-fluid w-100">
