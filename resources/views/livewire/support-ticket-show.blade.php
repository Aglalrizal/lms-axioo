                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <div class="d-flex align-items-center">
                                    @if ($ticket->reply->email_status === 'sent')
                                        <span class="badge bg-success me-2">
                                            <i class="fe fe-check-circle me-1"></i>Email Terkirim
                                        </span>
                                    @elseif ($ticket->reply->email_status === 'failed')
                                    ...
                                    @elseif ($ticket->reply->email_status === 'pending')
                ...
                <form wire:submit.prevent="sendReply">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <small class="text-muted">
                            ...
                            Pesan ini akan dikirim ke: <strong>{{ $ticket->email }}</strong>
                            <br>
                            <i class="fe fe-check-circle me-1"></i>
                            Status tiket akan otomatis diubah menjadi "Selesai"
                        </small>
                        ...
                        <div>
                            ...
                            <button type="submit" class="btn btn-primary">
                                <span wire:loading.remove>Kirim Balasan & Selesaikan Tiket</span>
                                <span wire:loading>
