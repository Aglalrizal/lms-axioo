    ...
    <div class="container">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                                ...
                                                @php
                                                    ...
                                                    $averageScore = $participants
                                                        ->map(function ($participant) use ($totalQuestions) {
                                                            return ($participant->total_score / $totalQuestions) * 100;
                                                        })
                                                        ->avg();
                                                @endphp
                            ...
                            <div class="col-md-4 col-sm-6 col-12 mb-3">
                                <div class="card bg-light">
                                    <div class="card-body text-center">
                                        <h4 class="text-info mb-1">{{ $participants->count() }}</h4>
                        ...
                        <div class="tab-content" id="tabContent">
                            ...
                            <div class="tab-pane fade @if ($activeTab === 'participants') show active @endif"
                                ...
                                <div class="card">
                                                        ...
                                                        @php
                                                            ...
                                                            $duration =
                                                                $participant->start_time && $participant->end_time
                                                                    ? $participant->start_time->diffInMinutes(
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="badge  bg-primary-soft">
                                                                    {{ number_format(($participant->total_score / $totalQuestions) * 100, 0) }}%
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <span
                                                ...
                                                @else
                                                    <tr>
                                                        <td colspan="6" class="text-center py-5">
                                                            ...
                                                            <h5 class="text-muted">Pilih Quiz Tertentu</h5>
                                                            <p class="text-muted mb-4">Untuk melihat peserta, silakan
                                                                akses halaman ini melalui tombol "Detail" pada quiz
                                                                tertentu.</p>
                                                            <a href="{{ route('admin.course.published.show', $course->slug) }}?activeTab=quiz"
                                    ...
                                    @if ($selectedQuiz && $participants->hasPages())
                                        <div class="p-3">
                                            {{ $participants->links() }}
                                        </div>
                                    @endif
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-6 col-12">
                                            <input type="search" class="form-control"
                                                placeholder="Cari pertanyaan..." wire:model.live="search" />
                                        </div>
                                    </div>
        ...
        return empty($this->search) || str_contains(strtolower($question->question), strtolower($this->search));
                                ...
                                @else
                                    <div class="card">
                                        <div class="card-body text-center py-5">
                                            <i class="bi bi-question-circle-fill fs-1 text-muted mb-3"></i>
                                            <h5 class="text-muted">Pilih Quiz Tertentu</h5>
                                            <p class="text-muted mb-4">Untuk melihat pertanyaan, silakan akses halaman
                                                ini melalui tombol "Detail" pada quiz tertentu.</p>
                                            <a href="{{ route('admin.course.published.show', $course->slug) }}?activeTab=quiz"
                                                class="btn btn-primary">
