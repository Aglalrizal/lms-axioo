                        ...
                        <div class="d-flex flex-column gap-5">
                            <div class="d-flex flex-row gap-2 align-items-center">
                                ...
                                <span class="text-primary fw-semibold">
                                    <span>Empower Your Learning Journey
                                        Today</span>
                                </span>
                            </div>
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        certifications to help you get the
                    ...
                    <div class="col-xl-10 col-md-10 col-12 mx-auto">
                        <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                            ...
                            <p class="mb-0 px-xl-5">
                                Discover a world of knowledge through our
                    ...
                    <div class="col-lg-6 col-md-8 col-12 mx-auto">
                        <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                            ...
                            <p class="mb-0">
                                ...
                                learn a new skill, or explore a passion, we
                            ...
                            <div class="card card-lift">
                                ...
                                <div class="card-body d-flex flex-column gap-4">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <h3 class="mb-0 h4">
                                            <a href="#!" class="text-inherit">Figma UI UX Design Course
                                                for the Beginner</a>
                                        </h3>
                            ...
                            <div class="card card-lift">
                                ...
                                <div class="card-body d-flex flex-column gap-4">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <h3 class="mb-0 h4">
                                            <a href="#!" class="text-inherit">About the Nuxt.js
                            ...
                            <div class="card card-lift">
                                ...
                                <div class="card-body d-flex flex-column gap-4">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <h3 class="mb-0 h4">
                                            <a href="#!" class="text-inherit">Supabase From Scratch:
                                                Serverless Database</a>
                                        </h3>
                        ...
                        <div class="d-flex flex-column gap-4 text-center mb-xl-7 mb-5">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <p class="mb-0">
                                    ...
                                    topics, Udemy supports your professional
                                    development.
                                </p>
                            </div>
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body p-5 d-flex flex-column gap-3">
                                ...
                                <div class="d-flex flex-column gap-6">
                                    <div class="d-flex flex-column gap-2">
                                        <span class="h4 mb-0">Transformative Learning
                                            Experience!</span>
                                        <p class="mb-0">
                                            "I was struggling to grasp the
                                            concepts in my subject until I
                                            enrolled in this course. The
                                            interactive lessons and the
                                            support from the instructors
                                            were incredible. I feel more
                                            confident and prepared for my
                                            exams now. Highly recommend it
                                            to anyone looking to excel!"
                                        </p>
                                    </div>
                                    <div class="d-flex flex-column gap-4">
                                        <div class="d-flex flex-row gap-3 align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text-secondary">Technical Co-Founder,
                                                    CTO at Block</span>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row gap-2 align-items-center">
                                            <a href="#!" class="icon-link icon-link-hover">
                                                <span>View this Bootstrap 5
                                                    course</span>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card shadow-lg">
                            <div class="card-body p-5 d-flex flex-column gap-3">
                                ...
                                <div class="d-flex flex-column gap-6">
                                    <div class="d-flex flex-column gap-2">
                                        <span class="h4 mb-0">Top-Notch Content and
                                            Teaching!</span>
                                        <p class="mb-0">
                                            "This course exceeded my
                                            expectations. The material is
                                            presented in a clear and
                                            engaging way, making even the
                                            most complex topics easy to
                                            understand. The quizzes and
                                            assignments helped reinforce my
                                            learning. I can’t thank the team
                                            enough for this fantastic
                                            resource."
                                        </p>
                                    </div>
                                    <div class="d-flex flex-column gap-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card shadow-lg">
                            <div class="card-body p-5 d-flex flex-column gap-3">
                                ...
                                <div class="d-flex flex-column gap-6">
                                    <div class="d-flex flex-column gap-2">
                                        <span class="h4 mb-0">Perfect for Career
                                            Advancement!</span>
                                        <p class="mb-0">
                                            "As a working professional, I
                                            needed a course that fit into my
                                            busy schedule. This course was
                                            perfect! The flexible pacing
                                            allowed me to learn at my own
                                            speed, and the practical
                                            applications taught in the
                                            course have already helped me in
                                            my job. I’m looking forward to
                                            taking more courses from this
                                            platform."
                                        </p>
                                    </div>
                                    <div class="d-flex flex-column gap-4">
                                        <div class="d-flex flex-row gap-3 align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <span class="text-secondary">Marketing
                                                    Specialist</span>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row gap-2 align-items-center">
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-8 col-12 mx-auto">
                        <div class="d-flex flex-column gap-2 text-center mb-xl-7 mb-5">
                            ...
                            <p class="mb-0">
                                Level up your coding skills by practicing
                                the hiring assessments of your dream
                                companies & ace your placement game!
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="d-flex flex-row gap-5">
                                ...
                                <div class="d-flex flex-column gap-4">
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <p class="mb-0 pe-xl-4">
                                            Lorem ipsum dolor sit amet,
                                            consectetur adi piscing elit.
                                            Aliquam sollicitudin eros enim,
                                            sed semper nunc tincidunt non.
                                        </p>
                                    </div>
                                    <div class="">
                                        <a href="#!" class="icon-link icon-link-hover">
