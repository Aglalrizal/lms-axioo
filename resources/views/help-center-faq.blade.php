                                ...
                                <div class="border p-3 rounded-3 mb-2" id="headingOne">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div class="pt-2">
                                            ...
                                            viverra quis neque. Nullam mattis mollis massa nec pulvinar. In eu tellus quis
                                            urna vestibulum
                                            pulvinar.
                                        </div>
                                    </div>
                                ...
                                <div class="border p-3 rounded-3 mb-2" id="headingTwo">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="pt-3">
                                            ...
                                            repudiandae esse
                                            excepturi sapiente tempore illo nobis fugiat nulla. Obcaecati voluptatum quos a
                                            vero minus dicta veniam illo cupiditate. Ipsam, fuga!
                                        </div>
                                    </div>
                                </div>
                                <!-- Card  -->
                            ...
                            <div class="accordion accordion-flush" id="accordionExample2">
                                ...
                                <div class="border p-3 rounded-3 mb-2" id="headingNine">
                                    ...
                                    <div id="collapseNine" class="collapse" aria-labelledby="headingNine"
                                        data-bs-parent="#accordionExample2">
                                        <div class="pt-3">Leggings occaecat craft beer farm-to-table, raw denim aesthetic
